...
const LOCAL_PORT = 8585; // 백엔드 로컬 서버 포트번호
...
} else if (clientHostName === 'my-event-app980926.s3-website.ap-northeast-2.amazonaws.com') {
  backendHostName = 'http://43.203.58.236:8787';
}
